let quotes = [{
    ...
    {
        "quoteText": "The people think of wealth and power as the greatest fate, But in this world a spell of health is the best state. What men call sovereignty is a worldly strife and constant war; Worship of God is the highest throne, the happiest of all estates.",
        "quoteAuthor": "Suleiman the Lawgiver"
    },
    {
    ...
    {
        "quoteText": "Laws are the sovereigns of sovereigns.",
        "quoteAuthor": "Louis XIV"
    },
    {
    ...
    {
        "quoteText": "You are what you choose to identify with. You have the choice. A mouse raised by pigeons",
        "quoteAuthor": "Lil B"
    },
    {
    ...
    {
        "quoteText": "While there's life, there's hope.",
        "quoteAuthor": "Marcus Tullius Cicero"
    },
    {
        "quoteText": "He who hesitates is lost. ...",
        "quoteAuthor": "Cato The Younger"
    },
    {
...
function getQuoteOfTheDay() {
    ...
    var startDate = new Date(todayDate.getFullYear(), 0, 0);
    var diff = todayDate - startDate;
    var oneDay = 1000 * 60 * 60 * 24;
    var day = Math.floor(diff / oneDay);
    return quotes[day - 1];
}

function addQuoteToPage() {
